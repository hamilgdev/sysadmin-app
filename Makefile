...
frontend.start_dev:
	...
	--rm --name host-sysadmin-app-dev-frontend \
...
frontend.start_prod:
	...
	--rm --name host-sysadmin-app-prod-frontend \
	--no-deps --service-ports frontend \
...
backend.start_dev:
	docker compose -f docker-compose.dev.yml run \
	--rm --name host-sysadmin-app-dev-backend \
...
backend.start_prod:
	docker compose -f docker-compose.prod.yml run \
	--rm --name host-sysadmin-app-prod-backend \
	--service-ports backend \
